        ...
        <div class="row sub-nav">
          @if(isset($topMenu))
            @foreach ($topMenu as $subnav)
              <div class="col-2">
                <a class="nav-link active" style="font-family:Playfair Display,serif;" href="{{url("article/display/". $subnav->id)}}">{{$subnav->metaTitle}}</a>
              </div>
            @endforeach
          @endif
        </div>
                    ...
                    <div class="single-amenities">
                      ...
                      <div class="amenities-details">
                        ...
                        <div class="d-flex justify-content-between mt-20">
                          <div>
                            <a href="{{url("article/display/". $post->id)}}" class="blog-post-btn">
                              Read More <span class="ti-arrow-right"></span>
                            </a>
                          </div>
                          <div class="category">
                            <a href="{{url("article/display/". $post->id)}}">
                              <span class="ti-folder mr-1"></span> Article
                            </a>
                          </div>
                        </div>
                      </div>
