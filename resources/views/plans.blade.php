			...
			<div class="row full-height justify-content-center">
				<div class="col-4 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
						<h6 class="mb-0 pb-3"><span>Name </span><span>Details</span></h6>
									...
									<div class="center-wrap">
										<div class="section text-center">
											<form action="{{route('login')}}"  method="post">
												@csrf
												<h4 class="mb-4 pb-3">Plan Name</h4>
												<div class="form-group">
													<input type="email" name="email" class="form-style" placeholder="Card Details" id="logemail" autocomplete="off">
									...
									<div class="center-wrap">
										<div class="section text-center">
											<form action="{{route('register')}}" method="post">
												@csrf
												<h4 class="mb-4 pb-3">Plan Details</h4>
												<div class="form-group">
		      	...
		      	<div class="col-4 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span>Name </span><span>Details</span></h6>
			          	<input class="checkbox" type="checkbox" id="reg-log2" name="reg-log"/>
			          	<label for="reg-log2"></label>
						<div class="card-3d-wrap mx-auto">
							<div class="card-3d-wrapper">
								<div class="card-front">
									<div class="center-wrap">
		      	...
		      	<div class="col-4 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span>Name </span><span>Details</span></h6>
			          	<input class="checkbox" type="checkbox" id="reg-log3" name="reg-log"/>
			          	<label for="reg-log3"></label>
						<div class="card-3d-wrap mx-auto">
							<div class="card-3d-wrapper">
								<div class="card-front">
									<div class="center-wrap">
