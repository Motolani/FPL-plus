    ...
    <div class="container">
      ...
      <div class="col-lg-1">
        ...
        <div class="col-lg-3  col-md-6 col-sm-6">
          <div class="single-footer-widget">
            <h6>About Us</h6>
            <p>
              Gain the edge inFPL over rivals in FPL and win money and other awards in paid leagues.
            </p>
          </div>
        </div>
        <div class="col-lg-1">
      ...
      <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
        <p class="footer-text m-0">
          Copyright &copy;<script>document.write(new Date().getFullYear());</script> FPL PLUS  <i class="fa fa-heart-o" aria-hidden="true"></i>
        </p>
      </div>
    </div>
  </footer>
